...
export class PortfolioComponent implements OnInit {
  ...
  projects = [
    ...
    // },
    {
      image: 'assets/img/projects/slackclone-laptop.png',
      imageByZoom: 'assets/img/projects/slackclone.png',
      title: 'Slackclone',
      description: 'A real-time messaging and collaboration application inspired by Slack',
      type: 'Angular | Firebase',
      link: 'https://anil-orhan.developerakademie.net/slack',
      github: 'https://github.com/anil-o/slackClone',
      isHovered: false,
    },
  ];
  ngOnInit(): void {
